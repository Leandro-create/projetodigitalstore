    ...
    <Layout>
      ...
      <Section title="Coleções em destaque" titleAlign="left">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <img src="../../imagens/collection-1.png" alt="camisa" className="rounded-[4px] w-full max-w-[420px] md:w-[420px] h-auto" />
          <img src="../../imagens/collection-2.png" alt="tenis" className="rounded-[4px] w-full max-w-[420px] md:w-[420px] h-auto ml-[0px]"/>
          <img src="../../imagens/collection-3.png" alt="headphones" className="rounded-[4px] w-full max-w-[420px] md:w-[420px] h-auto ml-[0px]"/>
        </div>
      </Section>
...
const produtos = [
  {
    ...
    image: "../../imagens/product-thumb-1.jpeg",
    price: 299,
    priceDiscount: 199,
  },
  {
    ...
    image: "../../imagens/product-thumb-2.jpeg",
    price: 699,
    priceDiscount: 499,
  },
  {
    ...
    image: "../../imagens/product-thumb-3.jpeg",
    price: 999,
    priceDiscount: 599,
  },
  {
    ...
    image: "../../imagens/product-thumb-4.jpeg",
    price: 170,
    priceDiscount: 100,
  },
  {
    ...
    image: "../../imagens/product-thumb-5.jpeg",
    price: 899,
    priceDiscount: 649,
  },
  {
